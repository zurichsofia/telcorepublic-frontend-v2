export const serviceDetailBlockStack =
  "flex flex-col gap-y-24 md:gap-y-32 lg:gap-y-40";

export const serviceDetailColumn =
  "mx-auto max-w-7xl px-5 text-center sm:px-8";
