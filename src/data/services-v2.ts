    ...
    content: [
      {
        type: "pillarLines",
        lines: [
          "We slice and dice your market however you desire.",
          "We transform your unstructured data into actionable advice.",
          "Our proven methodology takes the guesswork out of your strategic planning.",
        ],
      },
      {
        type: "subheading",
    ...
    content: [
      {
        type: "pillarLines",
        lines: [
          "Our team of industry experts will support your specific requirements.",
          "We establish partnerships without the red tape of large organizations.",
          "Our style is personalized, collaborative, unbiased, in-depth, leading-edge and disruptive.",
        ],
      },
      {
        type: "offers",
