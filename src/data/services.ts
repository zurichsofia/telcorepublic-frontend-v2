/**
 * Lead line (`desc`) matches each service hero on telcorepublic.com.
 * `content` is structured page copy from the same slug URLs.
 */
...
export const services = [
    ...
    content: [
      {
        ...
        items: [
          {
            role: "Telecom technology buyers",
      ...
      {
        type: "subheading",
        text: "What are the Telco Republic Disrupter Quintants?",
      },
      {
        type: "paragraph",
        text: "The Disrupter Quintants assess vendors across five segments (quintants) and two dimensions (strategy and execution) to provide guidance to telecom providers and vendors how to navigate emerging markets and how to make the best technology buying decisions.",
      },
      {
        type: "paragraph",
        text: "Disrupter Quintants provide a deep dive into vendors' ability to disrupt the traditional operations support systems (OSS) and business support systems (BSS) markets by enabling telecom providers to transition from traditional OSS and BSS to next-generation infrastructures, composed of horizontally architected, cognitive, cloud-based operational and business infrastructure as well as monetization and customer management orchestration.",
      },
      {
        type: "paragraph",
        text: "Disrupter Quintants are based on a rigorous and in-depth selection, evaluation and analysis of leading and emerging vendors.",
      },
  ...
  },
  {
    ...
    content: [
      {
        type: "paragraph",
        text: "We help you differentiate yourself against your competition.",
      },
      {
        type: "subheading",
  ...
  },
  {
    ...
    content: [
      {
        type: "paragraph",
        text: "Successfully Bring Your Products to Market With Our Tried and Tested Methodology. We support you with these tools.",
      },
      {
        type: "offers",
        items: [
  ...
  },
  {
    ...
    content: [
      {
        type: "paragraph",
        text: "We help you plan where to invest your resources.",
      },
      {
        type: "paragraph",
        text: "We slice and dice your market however you desire. We transform your unstructured data into actionable advice. Our proven methodology takes the guesswork out of your strategic planning.",
      },
      {
        type: "subheading",
  ...
  },
  {
    ...
    content: [
      {
        type: "paragraph",
        text: "We empower our clients with leading-edge insights to drive smarter decisions, unlock growth opportunities and stay ahead in a rapidly evolving market.",
      },
      {
        type: "paragraph",
        text: "Our team of industry experts will support your specific requirements. We establish partnerships without the red tape of large organizations. Our style is personalized, collaborative, unbiased, in-depth, leading-edge and disruptive.",
      },
      {
        type: "offers",
